...
#include "../../../../../MusicTableWidget/TableWidget.h"
...
constexpr auto qt_meta_stringdata_CLASSTableWidgetENDCLASS = QtMocHelpers::stringData(
    "TableWidget"
);
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSItemListWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSItemListWidgetENDCLASS = QtMocHelpers::stringData(
    "ItemListWidget"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSItemListWidgetENDCLASS_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSItemListWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSItemListWidgetENDCLASS_t qt_meta_stringdata_CLASSItemListWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14)   // "ItemListWidget"
    },
    "ItemListWidget"
};
#undef QT_MOC_LITERAL
...
Q_CONSTINIT static const uint qt_meta_data_CLASSItemListWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ItemListWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSItemListWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSItemListWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSItemListWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ItemListWidget, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSItemListWidgetENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}
